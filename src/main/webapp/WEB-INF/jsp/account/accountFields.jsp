    ...
    <tr>
        ...
        <td>
            <select name="account.languagePreference">
                <option value="English" ${account.languagePreference == 'English' ? 'selected' : ''}>English</option>
                <option value="Chinese" ${account.languagePreference == 'Chinese' ? 'selected' : ''}>Chinese</option>
            </select>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <select name="account.favouriteCategoryId">
                <option value="fish" ${account.favouriteCategoryId == 'FISH' ? 'selected' : ''}>fish</option>
                <option value="bird" ${account.favouriteCategoryId == 'BIRD' ? 'selected' : ''}>bird</option>
                <option value="cat" ${account.favouriteCategoryId == 'CAT' ? 'selected' : ''}>cat</option>
                <option value="dog" ${account.favouriteCategoryId == 'DOG' ? 'selected' : ''}>dog</option>
            </select>
        </td>
    </tr>
    <tr>
        <td>Enable MyList</td>
        <td><input type="checkbox" name="account.listOption" ${account.listOption ? 'checked' : ''} /></td>
    </tr>
    <tr>
        <td>Enable MyBanner</td>
        <td><input type="checkbox" name="account.bannerOption" ${account.bannerOption ? 'checked' : ''} /></td>
    </tr>
